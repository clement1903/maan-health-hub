      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="flex flex-col gap-10 lg:flex-row lg:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 font-mono text-[11px] uppercase tracking-[0.12em] text-muted">
            ...
            <div className="space-y-3">
              ...
              <Link to="/guides" className="block transition-colors hover:text-clay">
        ...
        <div className="mt-10 border-t border-border pt-6">
          <div className="mb-6 flex justify-center">
            <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 rounded-2xl border border-border bg-card px-8 py-5 shadow-[0_10px_40px_-18px_color-mix(in_oklab,var(--foreground)_25%,transparent)]">

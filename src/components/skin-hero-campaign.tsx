    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 md:py-28">
        ...
        <div className="max-w-4xl text-center">
          <h1 className="font-display text-5xl font-medium leading-[0.95] tracking-tight md:text-7xl lg:text-8xl">
        ...
        <div className="group relative mt-14 w-full max-w-4xl">
          ...
          <div
            className="absolute left-1/2 top-1/2 w-[260px] -translate-x-1/2 -translate-y-1/2 transition-transform duration-500 ease-out will-change-transform md:w-[300px]"

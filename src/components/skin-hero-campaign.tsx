  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 md:py-28">
        ...
        <div className="group relative mt-16 w-full max-w-3xl md:mt-20 lg:max-w-4xl">
          ...
          <div
            className="absolute left-1/2 top-[58%] w-[220px] -translate-x-1/2 -translate-y-1/2 transition-transform duration-500 ease-out will-change-transform md:w-[250px] lg:w-[270px]"

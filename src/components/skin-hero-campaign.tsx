  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 md:py-28">
        ...
        <div className="group relative mt-32 w-full max-w-2xl sm:mt-28 sm:max-w-3xl md:mt-36 lg:max-w-4xl">
          ...
          <div
            className="absolute left-1/2 top-[80%] w-[130px] -translate-x-1/2 -translate-y-1/2 transition-transform duration-500 ease-out will-change-transform sm:top-[76%] sm:w-[170px] md:w-[190px] lg:w-[210px]"
